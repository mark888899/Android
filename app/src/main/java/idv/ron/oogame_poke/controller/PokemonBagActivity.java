...
// 百寶箱頁面，列出我所有的寶可夢
public class PokemonBagActivity extends AppCompatActivity {
    MediaPlayer mPlayer;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pokemonbag);
        String title = String.format(getString(R.string.textPokemonBag));
        setTitle(title);
    }
            ...
            holder.tvHp.setText(hpInfo);
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(PokemonBagActivity.this,
                                PokemonInfoActivity.class);
                        Bundle bundle = new Bundle();
                        bundle.putSerializable("my", myPokemon);
