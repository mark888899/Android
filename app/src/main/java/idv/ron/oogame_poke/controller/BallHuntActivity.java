...
public class BallHuntActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            mPlayer = MediaPlayer.create(this,R.raw.newcut);
        ...
        String title = String.format(
                ...
                getString(R.string.Ball), fieldPokemon.getName());
        setTitle(title);
        handleViews();
    }
    ...
    private void handleViews() {
        ...
        catchtime = findViewById(R.id.catchtime);
        ...
        ivBall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String ct = String.format(getString(R.string.remain), b);
                catchtime.setText(ct);
    ...
    private void startCatchAnimation(boolean catchSuccess) {
        ...
        if (catchSuccess) {
            ...
            if (time >= 10) {
                Toast toast = Toast.makeText(BallHuntActivity.this, "神奇寶貝逃走了!", Toast.LENGTH_LONG);
                toast.show();
                finish();
            }
